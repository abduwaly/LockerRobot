...
class LockerTests {
    ...
    void should_save_bag_successfully_and_return_ticket_given_medium_bag_and_primary_robot_with_2_M_lockers_both_has_capacity() {
        ...
        AbstractLockerRobot robot = initPrimaryRobot(LockerType.M, 1, 1);
    ...
    void should_save_bag_successfully_into_second_locker_and_return_ticket_given_medium_bag_and_primary_robot_with_2_M_lockers_and_only_second_has_capacity() {
        Bag bag = new Bag(TEST_BAG_1, BagSize.MEDIUM);
        AbstractLockerRobot robot = initPrimaryRobot(LockerType.M, 0, 1);
    ...
    void should_return_no_storage_exception_given_medium_bag_and_primary_robot_with_2_M_lockers_both_without_capacity() {
        Bag bag = new Bag(TEST_BAG_1, BagSize.MEDIUM);
        AbstractLockerRobot robot = initPrimaryRobot(LockerType.M, 0, 0);
    ...
    void should_save_bag_into_second_given_large_bag_and_super_robot_with_2_L_lockers_and_second_has_more_vacancy_rate() {
        ...
        SuperAbstractLockerRobot robot = initSuperLockerRobot(2, 2, true, false);
    ...
    void should_save_bag_into_second_given_large_bag_and_super_robot_with_2_L_lockers_and_only_second_has_capacity() {
        ...
        SuperAbstractLockerRobot robot = initSuperLockerRobot(1, 2, true, false);
    ...
    void should_return_no_storage_exception_given_large_bag_and_super_robot_with_2_L_lockers_and_both_has_no_capacity() {
        ...
        SuperAbstractLockerRobot robot = initSuperLockerRobot(1, 1, true, true);
    ...
    void should_return_not_found_exception_given_a_ticket_of_medium_bag_onto_super_locker_robot() {
        ...
        SuperAbstractLockerRobot superRobot = initSuperLockerRobot(2, 2, true, true);
    ...
    void should_return_fake_ticket_exception_given_a_fake_ticket_of_large_bag_onto_super_locker_robot() {
        SuperAbstractLockerRobot robot = initSuperLockerRobot(1, 1, false, false);
    ...
    void should_return_locker_not_match_given_a_S_locker_set_to_super_locker_robot() {
        ...
        assertThrows(LockerNotMatchException.class, () -> new SuperAbstractLockerRobot(lockers));
    }
    ...
    void should_return_locker_not_match_given_a_L_locker_set_to_primary_locker_robot() {
        ...
        assertThrows(LockerNotMatchException.class, () -> new PrimaryAbstractLockerRobot(lockers));
    }

    private AbstractLockerRobot initPrimaryRobot(LockerType type, int firstCapacity, int secondCapacity) {
        ...
        return new PrimaryAbstractLockerRobot(lockers);
    }

    private SuperAbstractLockerRobot initSuperLockerRobot(int firstCapacity, int secondCapacity, boolean hasInitial1, boolean hasInitial2) {
        ...
        return new SuperAbstractLockerRobot(lockers);
    }
}
